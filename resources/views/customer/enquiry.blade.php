    ...
    <div class="page-header breadcrumb-wrap">
        <div class="container">
            <div class="breadcrumb">
                ...
                <span></span> Customer <span></span> My Enquries
            </div>
        </div>
    </div>
    ...
    <div id="body"> 
        <div class="chat-box">
            <div class="chat-box-header">
                ChatBot
                <span class="chat-box-toggle"><i class="fa fa-times" aria-hidden="true"></i></span>
            </div>
            ...
            <div class="chat-input">      
                <form>
                    ...
                    <button class="chat-submit" id="chat-submit" type="submit"><i class="fa fa-paper-plane" aria-hidden="true"></i></button>
                </form>      
            </div>
        </div> 
    </div>
