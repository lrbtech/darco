    ...
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">Product Group</h3>
          <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/vendor/dashboard">Home</a>
                </li>
                <li class="breadcrumb-item"><a href="#">Product Group</a>
                </li>
              </ol>
            </div>
          </div>
        ...
        <div class="content-header-right col-md-6 col-12">
            <button id="add_new" class="float-md-right btn btn-danger round btn-glow px-2" type="button">Add New ProductGroup</button>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">All Product Group</h4>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                  <div class="form-group col-md-12">
                      ...
                      <input autocomplete="off" type="text" id="group_name" name="group_name" class="form-control">
                  </div>
                </div>
                </form>
            </div>
...
function Save(){
  ...
  if(action_type == 1){
    ...
    $.ajax({
      url : '/vendor/update-product-group',
      type: "POST",
      data: formData,
      contentType: false,
      processData: false,
...
function Edit(id){
  spinner_body.show();   
  $.ajax({
    url : '/vendor/edit-product-group/'+id,
    type: "GET",
    dataType: "JSON",
    success: function(data)
    {
      spinner_body.hide();        
      $('#modal-title').text('Update Product Group');
...
function Delete(id){
    ...
    if (r == true) {
      spinner_body.show();   
      $.ajax({
        url : '/vendor/delete-product-group/'+id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
