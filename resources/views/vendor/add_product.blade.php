                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4 view_return_policy">
                            <div class="form-group">
                              ...
                              <input onfocus="if(this.value=='0') this.value='';" onfocusout="if(this.value=='') this.value='0';" value="0" type="number" class="form-control required" id="return_days" name="return_days">
                              <!-- <br>
                              <div class="custom-control custom-radio custom-control-inline">  
