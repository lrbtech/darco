    ...
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">Mobile Ad</h3>
          <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/admin/dashboard">Home</a>
                </li>
                <li class="breadcrumb-item"><a href="#">Mobile Ad</a>
                </li>
              </ol>
            </div>
          </div>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <select id="category" name="category" class="form-control">
                        <option value="0">Get Ideas</option>
...
$('#add_new').click(function(){
  ...
  $('#modal-title').text('Add mobile ad');
  $(".text-danger").remove();
...
function Edit(id){
  spinner_body.show();   
  $.ajax({
    url : '/admin/edit-mobile-ad/'+id,
    type: "GET",
    dataType: "JSON",
    success: function(data)
    {
      spinner_body.hide();   
      $('#modal-title').text('Update mobile ad');
...
function Delete(id,status){
    ...
    if (r == true) {
      spinner_body.show();   
      $.ajax({
        url : '/admin/delete-mobile-ad/'+id+'/'+status,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
