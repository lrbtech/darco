          ...
          <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Terms of Payment
                </li>
              </ol>
            </div>
          </div>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Terms of Payment</h4>
                ...
                <div class="card-content collapse show">
                  <div class="card-body">
                    <form action="/admin/update-terms-of-payment" class="form-horizontal" id="form" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <input type="hidden" name="id" id="id" value="{{$settings->id}}">
                        <div class="form-group">
                            <textarea name="terms_of_payment" id="terms_of_payment" class="tinymce">
                            <?php echo $settings->terms_of_payment; ?>
                            </textarea>
                        </div>
...
<script>
$('.terms-of-payment').addClass('active');
</script>
@endsection