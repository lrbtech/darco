            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-content collapse show">
                  <div class="card-body">
                    <form action="/admin/update-terms-and-conditions" class="form-horizontal" id="form" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <input type="hidden" name="id" id="id" value="{{$settings->id}}">
                        <div class="form-group">
                            <textarea name="terms_and_conditions" id="terms_and_conditions" class="tinymce">
