                    ...
                    <div class="col-xl-9">
                        <div class="product-detail accordion-detail">
                            ...
                            <div class="row mb-50 mt-30">
                                ...
                                <div class="col-md-2 col-sm-12 col-xs-12 mb-md-0 mb-sm-5"></div>
                                <div class="col-md-6 col-sm-12 col-xs-12 mb-md-0 mb-sm-5">
                                    ...
                                    <div class="detail-gallery pswp-gallery" id="gallery">
                                        <div class="carousel carousel-main" data-flickity='{"pageDots": false }'>
                                            ...
                                            <a  href="/project_image/{{$idea_book->image}}"
                                                ...
                                                target="_blank">
                                                <img src="/project_image/{{$idea_book->image}}" alt="" />
                                            </a>
                                            <!-- <img src="/project_image/{{$idea_book->image}}"/> -->
                                            </div>
                                        ...
                                        data-flickity='{ "asNavFor": ".carousel-main", "contain": true, "pageDots": false }'>
                                            <div class="carousel-cell"><img src="/project_image/{{$idea_book->image}}"/></div>
                                            @foreach($idea_book_images as $key => $row)
                            ...
                            <div class="row mt-60">
                            <div class="col-12">
                                <h2 class="section-title style-1 mb-30">Related Ideas</h2>
                            </div>
                            <div class="col-12">
