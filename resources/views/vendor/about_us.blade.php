            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-content collapse show">
                  <div class="card-body">
                    <form action="/vendor/update-about-us" class="form-horizontal" id="form" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <input type="hidden" name="id" id="id" value="{{$profile->id}}">
                        <div class="form-group">
                            <textarea name="about_us" id="about_us" class="tinymce">
                            <?php echo $profile->about_us; ?>
                            </textarea>
                        </div>
