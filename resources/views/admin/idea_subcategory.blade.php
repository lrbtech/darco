    ...
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">Idea SubCatetogory</h3>
                ...
                <div class="card-content collapse show">
                  <div class="card-body card-dashboard">
                    <table id="datatable" class="table table-striped table-bordered zero-configuration">
                      ...
                      <tbody>
                      @foreach($idea_subcategory as $key => $row)
                        <tr>
                            <td>{{$key + 1}}</td>
                            <td>
                            {{$row->category}}
...
$('#add_new').click(function(){
    ...
    $('#modal-title').text('Add Idea SubCategory');
    $(".text-danger").remove();
...
function Save(){
  ...
  if(action_type == 1){
    $.ajax({
      url : '/admin/save-idea-subcategory',
      type: "POST",
      data: formData,
      contentType: false,
      processData: false,
    ...
    $.ajax({
      url : '/admin/update-idea-subcategory',
      type: "POST",
      data: formData,
      contentType: false,
      processData: false,
...
function Edit(id){
  spinner_body.show();   
  $.ajax({
    url : '/admin/edit-idea-subcategory/'+id,
    type: "GET",
    dataType: "JSON",
    success: function(data)
    {
...
function Delete(id,status){
    ...
    if (r == true) {
      spinner_body.show();   
      $.ajax({
        url : '/admin/delete-idea-subcategory/'+id+'/'+status,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
