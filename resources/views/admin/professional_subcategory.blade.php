    ...
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">Professional SubCatetogory</h3>
                ...
                <div class="card-content collapse show">
                  <div class="card-body card-dashboard">
                    <table id="datatable" class="table table-striped table-bordered zero-configuration">
                      ...
                      <tbody>
                      @foreach($professional_subcategory as $key => $row)
                        <tr>
                            <td>{{$key + 1}}</td>
                            <td>
                            {{$row->category}}
...
$('#add_new').click(function(){
    ...
    $('#modal-title').text('Add Professional SubCategory');
    $(".text-danger").remove();
...
function Save(){
  ...
  if(action_type == 1){
    $.ajax({
      url : '/admin/save-professional-subcategory',
      type: "POST",
      data: formData,
      contentType: false,
      processData: false,
    ...
    $.ajax({
      url : '/admin/update-professional-subcategory',
      type: "POST",
      data: formData,
      contentType: false,
      processData: false,
...
function Edit(id){
  spinner_body.show();   
  $.ajax({
    url : '/admin/edit-professional-subcategory/'+id,
    type: "GET",
    dataType: "JSON",
    success: function(data)
    {
        spinner_body.hide();   
        $('#modal-title').text('Update Professional SubCategory');
...
function Delete(id,status){
    ...
    if (r == true) {
      spinner_body.show();   
      $.ajax({
        url : '/admin/delete-professional-subcategory/'+id+'/'+status,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
