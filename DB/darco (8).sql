...
CREATE TABLE `languages` (
  ...
  `arabic` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(50, '2023_08_24_074331_create_user_mobile_verifies_table', 30),
(51, '2023_08_24_074341_create_vendor_mobile_verifies_table', 30);
...
CREATE TABLE `orders` (
  ...
  `order_message` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `paid_description` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `cancel_description` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `products` (
  ...
  `description` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `specifications_arabic` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description_arabic` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mobile_description` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mobile_specifications` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `shipping_charge` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shipping_description` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `return_policy` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `return_items` (
  ...
  `description` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `return_pickup_description` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `settings` (
  ...
  `vendor_guide` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `professional_guide` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `purchase_guide` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `users` (`id`, `date`, `user_unique_id`, `username`, `first_name`, `last_name`, `mobile`, `email`, `firebase_key`, `password`, `remember_token`, `city`, `area`, `zipcode`, `country`, `address`, `country_code`, `profile_image`, `cover_image`, `status`, `created_at`, `updated_at`) VALUES
(1, '2023-02-03', '18208992101675383899', NULL, 'prasanth', 's', '86681746', 'prasanthats@gmail.com', NULL, '$2y$10$xWa4XKnBxAyd4q.R0VnI1OD7lCYUvNl3v4C0/DOjErLySRpoZ.xGu', NULL, 'Al Ahmadi Governorate', 'Al Aḩmadī', '13245', '🇰🇼    Kuwait', NULL, NULL, NULL, NULL, '1', '2023-02-02 18:54:59', '2023-07-18 07:29:45'),
(2, '2023-07-18', '6775519091689673485', NULL, 'test', 'account', '9876543210', 'prasanth1@gmail.com', NULL, '$2y$10$h.tKi7HWszCeMzibNmDXx.cZI3p8rI0eN3GtszWGB6rVCyBV0M3G.', NULL, 'Al Ahmadi Governorate', 'Al Aḩmadī', NULL, 'Kuwait', NULL, NULL, NULL, NULL, '0', '2023-07-18 04:14:45', '2023-07-18 04:14:45'),
(3, '2023-07-18', '5466083681689674059', NULL, 'test', 'account', '9876543211', 'prasanth2@gmail.com', NULL, '$2y$10$wZ/7dvWXsVoJMN.kWp/3lOIcGzMvZ9ydfxrrcflYDt4...EvSCpq2', NULL, 'Al Ahmadi Governorate', 'Al Aḩmadī', NULL, 'Kuwait', NULL, NULL, NULL, NULL, '1', '2023-07-18 04:24:19', '2023-07-18 04:24:19'),
(4, '2023-07-18', '3654642021689675138', NULL, 'test', 'account', '9876543213', 'prasanth3@gmail.com', NULL, '$2y$10$l2jcKM6XxiS96QQAtkv.f.mg9jeGa15iqRlM/PDKYlNhuCSw5PR.y', NULL, 'Al Jahra Governorate', 'Al Jahrā’', NULL, '🇰🇼    Kuwait', NULL, NULL, NULL, NULL, '1', '2023-07-18 04:42:18', '2023-07-18 04:42:18'),
(5, '2023-08-24', '12037721341692863907', NULL, 'ARavind', 'kumar', '123456789', 'aravind@lrbinfotech.com', NULL, '$2y$10$3ohyburkyTxBhfjTJvjhdehSCeMiQTGc32CKcmXD5CzAXlUqo79fu', 'dWROwJz2LVpLs7Tuq3LyYptJ4iHVON8O7DCzZadh', 'Abu Dhabi Emirate', 'Al Ain City', NULL, 'United Arab Emirates', NULL, '971', NULL, NULL, '1', '2023-08-24 05:28:27', '2023-08-24 05:28:27');
...
CREATE TABLE `user_mobile_verifies` (
  ...
  `verify_count` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Dumping data for table `user_mobile_verifies`
--

INSERT INTO `user_mobile_verifies` (`id`, `mobile`, `otp`, `verify_count`, `status`, `created_at`, `updated_at`) VALUES
(1, '123456789', '7598', NULL, '0', '2023-08-24 05:28:09', '2023-08-24 05:28:09');
...
--
-- Table structure for table `vendor_mobile_verifies`
--

CREATE TABLE `vendor_mobile_verifies` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `mobile` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `otp` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `verify_count` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Indexes for table `vendor_mobile_verifies`
--
ALTER TABLE `vendor_mobile_verifies`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `user_mobile_verifies`
--
ALTER TABLE `user_mobile_verifies`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `vendor_mobile_verifies`
--
ALTER TABLE `vendor_mobile_verifies`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
