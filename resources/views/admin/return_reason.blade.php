    ...
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">Return Reason</h3>
          <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/admin/dashboard">Home</a>
                </li>
                <li class="breadcrumb-item"><a href="#">All Return Reason</a>
                </li>
              </ol>
            </div>
          </div>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">All Return Reason</h4>
                ...
                <div class="card-content collapse show">
                  <div class="card-body card-dashboard">
                    <table id="datatable" class="table table-striped table-bordered zero-configuration">
                      ...
                      <tbody>
                      @foreach($return_reason as $key => $row)
                        <tr>
                            <td>{{$key + 1}}</td>
                            <td>
                              {{$row->return_reason}}
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input autocomplete="off" type="text" id="return_reason" name="return_reason" class="form-control">
                </div>
...
$('#add_new').click(function(){
  ...
  $('#modal-title').text('Add Return Reason');
  $(".text-danger").remove();
...
function Save(){
  ...
  if(action_type == 1){
    ...
    $.ajax({
      url : '/admin/update-return-reason',
      type: "POST",
      data: formData,
      contentType: false,
      processData: false,
...
function Edit(id){
  spinner_body.show();   
  $.ajax({
    url : '/admin/edit-return-reason/'+id,
    type: "GET",
    dataType: "JSON",
    success: function(data)
    {
      spinner_body.hide();   
      $('#modal-title').text('Update Return Reason');
      $('#save').text('Save Change');
      $('input[name=return_reason]').val(data.return_reason);
...
function Delete(id){
    ...
    if (r == true) {
      spinner_body.show();   
      $.ajax({
        url : '/admin/delete-return-reason/'+id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
