                    ...
                    <table class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="form-group pb-1">
                                    <input type="checkbox" name="dashboard" id="dashboard" class="switchery" />
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group pb-1">
                                    <input type="checkbox" name="customers" id="customers" class="switchery" />
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group pb-1">
                                    <input type="checkbox" name="vendors" id="vendors" class="switchery" />
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group pb-1">
                                    <input type="checkbox" name="reviews" id="reviews" class="switchery" />
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group pb-1">
                                    <input type="checkbox" name="product_category" id="product_category" class="switchery" />
                                    <label for="product_category" class="font-medium-2 text-bold-600 ml-1"></label>
                                </div>
                            </td>
                            <td>
                                <div class="form-group pb-1">
                                    <input type="checkbox" name="product_category_create" id="product_category_create" class="switchery" />
                                    <label for="product_category_create" class="font-medium-2 text-bold-600 ml-1"></label>
                                </div>
                            </td>
                            <td>
                                <div class="form-group pb-1">
                                    <input type="checkbox" name="product_category_edit" id="product_category_edit" class="switchery" />
                                    <label for="product_category_edit" class="font-medium-2 text-bold-600 ml-1"></label>
                                </div>
                            </td>
                            <td>
                                <div class="form-group pb-1">
                                    <input type="checkbox" name="product_category_delete" id="product_category_delete" class="switchery" />
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group pb-1">
                                    <input type="checkbox" name="professional_category" id="professional_category" class="switchery" />
                                    <label for="professional_category" class="font-medium-2 text-bold-600 ml-1"></label>
                                </div>
                            </td>
                            <td>
                                <div class="form-group pb-1">
                                    <input type="checkbox" name="professional_category_create" id="professional_category_create" class="switchery" />
                                    <label for="professional_category_create" class="font-medium-2 text-bold-600 ml-1"></label>
                                </div>
                            </td>
                            <td>
                                <div class="form-group pb-1">
                                    <input type="checkbox" name="professional_category_edit" id="professional_category_edit" class="switchery" />
                                    <label for="professional_category_edit" class="font-medium-2 text-bold-600 ml-1"></label>
                                </div>
                            </td>
                            <td>
                                <div class="form-group pb-1">
                                    <input type="checkbox" name="professional_category_delete" id="professional_category_delete" class="switchery" />
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group pb-1">
                                    <input type="checkbox" name="idea_category" id="idea_category" class="switchery" />
                                    <label for="idea_category" class="font-medium-2 text-bold-600 ml-1"></label>
                                </div>
                            </td>
                            <td>
                                <div class="form-group pb-1">
                                    <input type="checkbox" name="idea_category_create" id="idea_category_create" class="switchery" />
                                    <label for="idea_category_create" class="font-medium-2 text-bold-600 ml-1"></label>
                                </div>
                            </td>
                            <td>
                                <div class="form-group pb-1">
                                    <input type="checkbox" name="idea_category_edit" id="idea_category_edit" class="switchery" />
                                    <label for="idea_category_edit" class="font-medium-2 text-bold-600 ml-1"></label>
                                </div>
                            </td>
                            <td>
                                <div class="form-group pb-1">
                                    <input type="checkbox" name="idea_category_delete" id="idea_category_delete" class="switchery" />
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group pb-1">
                                    <input type="checkbox" name="city" id="city" class="switchery" />
                                    <label for="city" class="font-medium-2 text-bold-600 ml-1"></label>
                                </div>
                            </td>
                            <td>
                                <div class="form-group pb-1">
                                    <input type="checkbox" name="city_create" id="city_create" class="switchery" />
                                    <label for="city_create" class="font-medium-2 text-bold-600 ml-1"></label>
                                </div>
                            </td>
                            <td>
                                <div class="form-group pb-1">
                                    <input type="checkbox" name="city_edit" id="city_edit" class="switchery" />
                                    <label for="city_edit" class="font-medium-2 text-bold-600 ml-1"></label>
                                </div>
                            </td>
                            <td>
                                <div class="form-group pb-1">
                                    <input type="checkbox" name="city_delete" id="city_delete" class="switchery" />
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group pb-1">
                                    <input type="checkbox" name="orders" id="orders" class="switchery" />
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group pb-1">
                                    <input type="checkbox" name="settlement_report" id="settlement_report" class="switchery" />
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group pb-1">
                                    <input type="checkbox" name="users" id="users" class="switchery" />
                                    <label for="users" class="font-medium-2 text-bold-600 ml-1"></label>
                                </div>
                            </td>
                            <td>
                                <div class="form-group pb-1">
                                    <input type="checkbox" name="users_create" id="users_create" class="switchery" />
                                    <label for="users_create" class="font-medium-2 text-bold-600 ml-1"></label>
                                </div>
                            </td>
                            <td>
                                <div class="form-group pb-1">
                                    <input type="checkbox" name="users_edit" id="users_edit" class="switchery" />
                                    <label for="users_edit" class="font-medium-2 text-bold-600 ml-1"></label>
                                </div>
                            </td>
                            <td>
                                <div class="form-group pb-1">
                                    <input type="checkbox" name="users_delete" id="users_delete" class="switchery" />
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group pb-1">
                                    <input type="checkbox" name="roles" id="roles" class="switchery" />
                                    <label for="roles" class="font-medium-2 text-bold-600 ml-1"></label>
                                </div>
                            </td>
                            <td>
                                <div class="form-group pb-1">
                                    <input type="checkbox" name="roles_create" id="roles_create" class="switchery" />
                                    <label for="roles_create" class="font-medium-2 text-bold-600 ml-1"></label>
                                </div>
                            </td>
                            <td>
                                <div class="form-group pb-1">
                                    <input type="checkbox" name="roles_edit" id="roles_edit" class="switchery" />
                                    <label for="roles_edit" class="font-medium-2 text-bold-600 ml-1"></label>
                                </div>
                            </td>
                            <td>
                                <div class="form-group pb-1">
                                    <input type="checkbox" name="roles_delete" id="roles_delete" class="switchery" />
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group pb-1">
                                    <input type="checkbox" name="terms_and_conditions" id="terms_and_conditions" class="switchery" />
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group pb-1">
                                    <input type="checkbox" name="privacy_policy" id="privacy_policy" class="switchery" />
