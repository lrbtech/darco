          ...
          <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Purchase Guide
                </li>
              </ol>
            </div>
          </div>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Purchase Guide</h4>
                ...
                <div class="card-content collapse show">
                  <div class="card-body">
                    <form action="/admin/update-purchase-guide" class="form-horizontal" id="form" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <input type="hidden" name="id" id="id" value="{{$settings->id}}">
                        <div class="form-group">
                            <textarea name="purchase_guide" id="purchase_guide" class="tinymce">
                            <?php echo $settings->purchase_guide; ?>
                            </textarea>
                        </div>
...
<script>
$('.purchase-guide').addClass('active');
