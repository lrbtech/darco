    ...
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">SubCatetogory</h3>
          <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                <!-- <li class="breadcrumb-item"><a href="/admin/dashboard">Home</a></li> -->
                {{\App\Http\Controllers\Admin\CategoryController::viewbreadcrumb($parent_id)}}
                    ...
                    <table id="datatable" class="table table-striped table-bordered zero-configuration">
                      ...
                      @foreach($subcategory as $key => $row)
                        <tr>
                            <td>{{$key + 1}}</td>
                            <td>
                            {{\App\Http\Controllers\Admin\CategoryController::viewcategorylink($row->id)}}
                            </td>
                            <td>
...
function Delete(id,status){
    ...
    if (r == true) {
      spinner_body.show();   
      $.ajax({
        url : '/admin/delete-subcategory/'+id+'/'+status,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
