...
class PaymentsoutExport implements FromCollection, ShouldAutoSize , WithHeadings , WithMapping
{
    ...
    public function map($data): array
    {
        ...
        $payable_amount = ($data->total - $data->commission_amount) - $data->service_charge;
